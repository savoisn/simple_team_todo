defmodule SimpleTeamTodoWeb.TaskControllerTest do
  ...
  describe "create task" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      create_attrs = Map.put(create_attrs, :owner, user.id)
      create_attrs = Map.put(create_attrs, :creator, user.id)
      create_attrs = Map.put(create_attrs, :project, project.id)
